...
export const mbtiProfiles: MbtiProfile[] = [
  ...
  // Explorers
  {
    ...
    description: "A fiercely independent and masterfully adaptable pragmatist who interacts with the world through real experimentation and tactical problem-solving.",
